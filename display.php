...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                ...
                <button type="button" class="btn btn-primary btn-lg show-modal" data-toggle="modal" data-target="#myModal">
                  Login
                    ...
                    <li class="nav-item">
                        <a class="nav-link active show-popup" aria-current="page" href="register.php">Register</a>
 ...
 <div class="slick-slider" style="background-color:#ffc800;">
        <div class="element element-1 category"><span class="ele">All blogs</span></div>
        <div class="element element-2 category"><span class="ele">Sports blogs</span></div>
        <div class="element element-3 category"><span class="ele">Technology blogs</span></div>
        <div class="element element-4 category"><span class="ele">Music blogs</span></div>
        <div class="element element-5 category"><span class="ele">Environment blogs</span></div>
        <div class="element element-6 category"><span class="ele">Food blogs</span></div>
        ...
        <!-- <button type="button"claas="slick-next" >&it; </button>
