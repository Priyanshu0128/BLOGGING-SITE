        ...
        <div class="container-fluid card_wrapper">
            <div class="row">
                ...
                while ($row = mysqli_fetch_assoc($res)) { ?>
                    ...
                    <div class="col-md-3">
                        <a href="readcard.php?pid=<?php echo $row[
                            "id"
                        ]; ?>" style="text-decoration:none;">
                            <div class="card ">
                                <img src="uploads/<?= !empty($row["image"])
                                    ? $row["image"]
                                    : "21.jpeg" ?>" class="card-img-top img_wrapper  img-size" alt="...">
                                <div class="card-body">
                                    <h5 class="card-category "><?php echo $row[
                                        "category"
                                    ]; ?></h5>
                                    <h3 class="card-title "><?php echo $row[
                                        "title"
                                    ]; ?></h3>
                                    <p class="card-text"><?php echo $row[
                                        "discription"
                                    ]; ?></p>
                                    <small class="text-muted" style="color:#000"></small>Date : <?php echo $row[
                                        "date"
                                    ]; ?></small>
                                </div>
                            </div>
                        ...
                        $('.card_wrapper .row ').empty()
                            $.each(res.posts, (i, val) => {
                                $('.card_wrapper .row').append(` 
                                    ...
                                    <div class="col-md-3">
                                        <a href="readcard.php?pid=${val.id}"> 
                                            <div class="card">
